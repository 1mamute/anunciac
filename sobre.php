		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 animate-box">
					<h1><span class="colored">Contate</span>-Nos</h1>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="row">
				<div class="col-md-3">
					...
					<ul class="contact-info">
						<li><i class="icon-map"></i>Rua Dr. Rodolfo de Camargo, 83 Piracicaba-SP</li>
						<li><i class="icon-phone"></i>+55(19) 3444-3232</li>
						<li><i class="icon-envelope"></i><a href="#">chobacaio@gmail.com</a></li>
						<li><i class="icon-globe"></i><a href="#">www.facebook.com/chobacaio</a></li>
					</ul>
				</div>
