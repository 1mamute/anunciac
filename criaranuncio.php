		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 animate-box">
					<h1><span class="colored">Alugar</span> Propriedades</h1>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box" data-animate-effect="fadeIn">
					<h2>Nos oferecemos os melhores preços</h2>
					...
					<div class="fh5co-property">
						...
						<div class="fh5co-property-innter">
							...
							<div class="price-status">
		                 	<span class="price">RR$4,000 <span class="per">/Mês</span></span>
		               </div>
				...
				<div class="col-md-4 item-block animate-box" data-animate-effect="fadeIn">
					...
					<div class="fh5co-property">
						...
						<div class="fh5co-property-innter">
							<h3><a href="#">Algum Lugar para alterar</a></h3>
							<div class="price-status">
		                 	<span class="price">R$1,000 <span class="per">/Mês</span></span>
		               </div>
		               <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque dicta magni amet atque doloremque velit unde adipisci omnis hic quaerat.</p>
	            	</div>
	            	<p class="fh5co-property-specification">
				...
				<div class="col-md-4 item-block animate-box" data-animate-effect="fadeIn">
					<div class="fh5co-property">
						...
						<div class="fh5co-property-innter">
							<h3><a href="#">Algum lugar para alterar</a></h3>
							<div class="price-status">
		                 	<span class="price">R$5,500 <span class="per">/Mês</span></span>
		               </div>
		               <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque dicta magni amet atque doloremque velit unde adipisci omnis hic quaerat.</p>
	            	</div>
	            	<p class="fh5co-property-specification">
				...
				<div class="col-md-4 item-block animate-box" data-animate-effect="fadeIn">
					...
					<div class="fh5co-property">
						...
						<div class="fh5co-property-innter">
							...
							<div class="price-status">
		                 	<span class="price">R$2,999 <span class="per">/Mês</span></span>
		               </div>
		               <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque dicta magni amet atque doloremque velit unde adipisci omnis hic quaerat.</p>
	            	</div>
	            	<p class="fh5co-property-specification">
				...
				<div class="col-md-4 item-block animate-box" data-animate-effect="fadeIn">
					...
					<div class="fh5co-property">
						...
						<div class="fh5co-property-innter">
							<h3><a href="#">Algum Lugar para alterar</a></h3>
							<div class="price-status">
		                 	<span class="price">R$40,000 <span class="per">/Mês</span></span>
		               </div>
		               <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque dicta magni amet atque doloremque velit unde adipisci omnis hic quaerat.</p>
	            	</div>
	            	<p class="fh5co-property-specification">
				...
				<div class="col-md-4 item-block animate-box" data-animate-effect="fadeIn">
					...
					<div class="fh5co-property">
						...
						<div class="fh5co-property-innter">
							<h3><a href="#">15 Apartments Of Type B</a></h3>
							<div class="price-status">
		                 	<span class="price">R$2000 <span class="per">/Mês</span></span>
		               </div>
		               <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque dicta magni amet atque doloremque velit unde adipisci omnis hic quaerat.</p>
	            	</div>
	            	<p class="fh5co-property-specification">
				...
				<div class="col-md-4 item-block animate-box" data-animate-effect="fadeIn">
					...
					<div class="fh5co-property">
						...
						<div class="fh5co-property-innter">
							<h3><a href="#">Algum Lugar para alterar</a></h3>
							<div class="price-status">
		                 	<span class="price">R$2,400 <span class="per">/Mês</span></span>
		               </div>
		               <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque dicta magni amet atque doloremque velit unde adipisci omnis hic quaerat.</p>
	            	</div>
	            	<p class="fh5co-property-specification">
				...
				<div class="col-md-4 item-block animate-box" data-animate-effect="fadeIn">
					<div class="fh5co-property">
						...
						<div class="fh5co-property-innter">
							<h3><a href="#">Algum lugar para alterar</a></h3>
							<div class="price-status">
		                 	<span class="price">R$5,000 <span class="per">/Mês</span></span>
		               </div>
		               <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque dicta magni amet atque doloremque velit unde adipisci omnis hic quaerat.</p>
	            	</div>
	            	<p class="fh5co-property-specification">
				...
				<div class="col-md-4 item-block animate-box" data-animate-effect="fadeIn">
					...
					<div class="fh5co-property">
						...
						<div class="fh5co-property-innter">
							<h3><a href="#">Algum Lugar para alterar</a></h3>
							<div class="price-status">
		                 	<span class="price">R$1,540 <span class="per">/Mês</span></span>
		               </div>
		               <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque dicta magni amet atque doloremque velit unde adipisci omnis hic quaerat.</p>
	            	</div>
	            	<p class="fh5co-property-specification">
	            		<span><strong>3500</strong> Sq Ft</span>  <span><strong>3</strong> </span>  <span><strong>3.5</strong> Banheiros</span>  <span><strong>2</strong> Garagens</span>
	            	</p>
					</div>
				</div>
